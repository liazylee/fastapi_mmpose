...
class VideoTransformTrack(VideoStreamTrack):
    def __init__(self, track, config=None, ):
        ...
        # self.pose_service = FastThreadedProcessor()
        # self.use_threaded = self.config.use_threaded_processor
        # if self.use_threaded:
        #     self.pose_service = ThreadedPoseService(self.config)
        # else:
        #     logger.info("Using async pose service")
    ...
    async def recv(self):
        ...
        # vis_img, pose_results = self.pose_service.process_frame(img)
